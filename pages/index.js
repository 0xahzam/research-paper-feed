          ...
          <Flex width={{base:"50px",lg:"20vw"}}>
            <TabList border={"0px"}>
              <Flex flexDir={"column"} gap={"4px"}>
                ...
                >
                  <Text textAlign={"right"} fontSize={{base:"14px",lg:"18px"}}>physics</Text>
                </Tab>
                <Tab
                  _selected={{color:"blue", background:""}}
                  _active={""}
                  ...
                  justifyContent={"right"}
                >
                  <Text textAlign={"right"} fontSize={{base:"14px",lg:"18px"}}>ai/ml</Text>
                </Tab>
                <Tab
                  _selected={{color:"blue", background:""}}
                  _active={""}
                  ...
                  justifyContent={"right"}
                >
                  <Text textAlign={"right"} fontSize={{base:"14px",lg:"18px"}}>bio-info</Text>
                </Tab>
              </Flex>
            </TabList>
          </Flex>
